---
title: "Apache Hive : Supported Features:  Apache Hive 4.1"
date: 2025-09-27
---

# Apache Hive : Supported Features: Apache Hive 4.1

This table covers all mandatory features from [SQL:2023](https://en.wikipedia.org/wiki/SQL:2023) as well as optional features that Hive implements.
...
| E021-11 | POSITION function | Partial | Mandatory | Standard: POSITION(*substr* IN *str*). Hive: POSITION(*substr*, *str*, [, *pos*]) |
| E021-12 | Character comparison | Yes | Mandatory |  |
| E031 | Identifiers | Partial | Mandatory | Unquoted identifiers use C syntax ([A-Za-z0-9][A-Za-z0-9_]*). Quoted identifiers can have any character. |
| E031-01 | Delimited identifiers | Yes | Mandatory | Quoting done with ` rather than " by default, with " if hive.support.quoted.identifiers=standard |
...
| E061-07 | Quantified comparison predicate | Yes | Mandatory |  |
...
| E182 | Host language binding | No | Mandatory |  |
...
| F033 | AL TER T ABLE statement: DROP COLUMN clause | Yes | Optional |  |
...
| F051 | Basic date and time | Partial | Mandatory | No support for precision in TIMESTAMP.No support for TIME type. |
...
| F051-03 | TIMESTAMP data type (including support of TIMESTAMP literal) with fractional seconds precision of at least 0 and 6. | Partial | Mandatory | No support for precision.Intervals don't match spec syntax. |
